        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-8 p-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold">Import Brands</h1>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <p className="mb-4 text-sm text-muted-foreground">
                                Upload a CSV file with the following required columns: brand_name, website_url, category_primary, description, customer_age_min, customer_age_max, us_based.
                            </p>
                            <p className="mb-4 text-sm text-muted-foreground">
...
EcoWear,https://ecowear.com,Fashion,Lifestyle,,https://instagram.com/ecowear,https://tiktok.com/@ecowear,Sustainable fashion brand,25,45,1
TechGadgets,https://techgadgets.com,Technology,,,https://instagram.com/techgadgets,,Latest tech accessories,18,35,true`}
                        </pre>
                    </div>
                </div>
            </div>
